...
- Using Headphone is recommended for the best gaming experience. 
...
## Obstacles 
- The preset levels include walls on various blocks which prohibit the users from moving forward. 
